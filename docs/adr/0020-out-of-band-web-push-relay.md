...
- **Supersedes ADR-0019's "ntfy is the sole out-of-band channel."** The realized out-of-band channel is now the **Push relay**; ntfy is a *protocol* it speaks, not the service it uses.
