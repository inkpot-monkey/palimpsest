...

{
  ...
  services.hyprpaper = {
    ...
    settings = {
      ipc = "on";
      splash = false;
      preload = [ "/home/inkpotmonkey/code/nixos/users/inkpotmonkey/assets/wallpaper.png" ];
      wallpaper = [ ",/home/inkpotmonkey/code/nixos/users/inkpotmonkey/assets/wallpaper.png" ];
    };
  };
