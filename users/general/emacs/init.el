...
(use-package
 ...
 :bind (:map dired-mode-map ("i" . wdired-change-to-wdired-mode))
...
(use-package
 ...
 (setq consult-find-args
       "fd --color=always --full-path --hidden --exclude .git"))
...
(use-package crux :bind ("M-o" . crux-other-window-or-switch-buffer))
...
(use-package
 ...
 :bind
 (("C-z" . undo-fu-only-undo) ("C-S-z" . undo-fu-only-redo)))
...
(use-package
 ...
 (setq dashboard-items
       '((recents . 5) (projects . 5) (agenda . 5) (registers . 5)))
...
(use-package
 tempel
 :bind
 (("M-+" . tempel-complete) ;; Alternative to completion-at-point
  ("M-*" . tempel-insert))
 :init
