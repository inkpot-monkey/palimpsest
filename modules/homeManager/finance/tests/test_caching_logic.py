...
class TestCachingLogic(unittest.TestCase):
    def setUp(self):
        ...
        self.hook.predict = MagicMock(
            return_value={"account": "Expenses:AI:Predicted", "payee": "AI Payee"}
        )
    ...
    def create_txn(self, description, amount_val="-10.00"):
        return data.Transaction(
            ...
            [
                data.Posting(
                    "Assets:Bank",
                    amount.Amount(number.D(amount_val), "USD"),
                    None,
                    None,
                    None,
                    None,
    ...
    def create_history_entry(self, description, account):
        ...
        return data.Transaction(
            ...
            [
                data.Posting(
                    "Assets:Bank",
                    amount.Amount(number.D("-10.00"), "USD"),
                    None,
                    None,
                    None,
                    None,
    ...
    def test_cache_hit_skips_llm(self):
        ...
        existing_entries = [
            self.create_history_entry("Starbucks", "Expenses:Food:Coffee")
        ]
    ...
    def test_cache_hit_exact_whitespace(self):
        ...
        existing_entries = [
            self.create_history_entry("Starbucks", "Expenses:Food")
        ]  # No trailing
